...
flags.DEFINE_string(
    "model_file", None, "The model file that the SentencePiece model was trained on."
)
...
class KwProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids,predictions,5,[1,2,4,5,6,7,8,9],average="macro")
                recall = tf_metrics.recall(label_ids,predictions,5,[1,2,4,5,6,7,8,9],average="macro")
                f = tf_metrics.f1(label_ids,predictions,5,[1,2,4,5,6,7,8,9],average="macro")
                #
                return {
